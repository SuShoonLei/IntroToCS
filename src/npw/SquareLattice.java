...
public class SquareLattice {
    ...
    private void paintTheImage() {
        ...
        SPainter cassatt = new SPainter(" Squared Art", canvasWidth, canvasHeight);
...
// move cassatt left the required number of squares , to paint the
    ...
    private void paintSquareTile ( SPainter cassatt , SSquare sq) {
...
//            paintConcentricSubSquares(cassatt, sq);
//        } else {
...
//                paintLeftSideSubSquares ( cassatt , sq) ;
//            } else {
//                paintRightSideSubSquares ( cassatt , sq) ;
//            }
//        }
    }
//    private void paintConcentricSubSquares ( SPainter cassatt , SSquare sq) {
//        int numPaintedSqs = 1;
...
//            cassatt . paint ( smallerSq ) ;
//            numPaintedSqs = numPaintedSqs + 1;
//        }
//    }

//    private void paintLeftSideSubSquares ( SPainter cassatt , SSquare sq ) {
//        int numPaintedSqs = 1;
