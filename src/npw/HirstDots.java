...
public class HirstDots {
    ...
    private void paintTheImage(){
        ...
        SPainter cassatt = new SPainter("Hirst Dots", canvasWidth, canvasHeight);
...
//            chaosFactor = (1.0/totalNumberOfColumns)*colNumber;
    ...
    private void paintOneColumn(SPainter cassatt, SSquare sq, int numberOfSquaresPerColumn, double chaosFactor) {
        ...
        while(squareNumber < numberOfSquaresPerColumn){
            ...
            paintOneDiamond(cassatt,sq.circumscribingCircle(),chaosFactor);
    ...
    private void paintOneDiamond(SPainter cassatt, SCircle sq, double chaosFactor) {
