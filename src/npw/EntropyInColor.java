...
public class EntropyInColor {
    ...
    private void paintTheImage(){
        ...
        SPainter cassatt = new SPainter("EntropyInColor", canvasWidth, canvasHeight);
        ...
        while (colNumber < totalNumberOfColumns){
            ...
            cassatt.setColor(chooseColor(colNumber));
    ...
    private Color chooseColor(int colNumber) {
        int redness = 240- ((5*colNumber)%240);
        return new Color(redness,250,250);
    }
