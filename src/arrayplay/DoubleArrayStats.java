...
public class DoubleArrayStats {
    ...
    private static void interpretAddCommand(Scanner commandReader) {
        ...
        try {
            ...
            System.out.println("You didn't enter a double value to add.");
            return;
        }
        ensureCapacity();
    ...
    private static Scanner establishScanner(String fileName) throws FileNotFoundException {
        ...
        String path = homeDirectory + separator + "Desktop" + separator + "public_html" + separator + "data.txt" + separator;
    ...
    private static void readNumbers() throws FileNotFoundException {
        ...
        while (scanner.hasNext()) {
            ensureCapacity();
            numbers[numberOfNumbers] = scanner.nextDouble();
            numberOfNumbers++;
        }
    }
